...
\begin{enumerate}
	\item Form the differential equation representing the family of curves $y=\frac{A}{x}+5$, by eliminating the arbitrary constant $A$.
     ...
     \item Find the acute angle between the planes $\overrightarrow{r}.\hspace{6pt}\brak{\hat{i}-2\hat{j}-2\hat{k}}=1$ and $\overrightarrow{r}.\hspace{6pt}\brak{3\hat{i}-6\hat{j}+2\hat{k}}=0$.
     ...
     \item Find :
        \begin{align*}
         \int_{-\frac{\pi}{4}}^{0}  \frac{1+\tan{x}}{1- \tan{x}}.
        \end{align*}
    ...
    \item Solve the following  equation :
     \begin{align*}
         \dfrac{dx}{dydifferential}+x=\brak{\tan{y}+\sec^{2}{y}}.
     \end{align*}
